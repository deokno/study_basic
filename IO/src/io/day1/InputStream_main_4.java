...
/*
  ...
  Data Sourceㅇ======>ㅇ 프로그램 ㅇ======>ㅇ Data Destinatio
      			입력스트림     출력스트림
    		I	nputStream 	OutputStream          
...
*/   	
	...
	public static void main(String[] args) throws IOException {
		...
		// dataArr 변수의 용도는 빨대(System.in, 키보드)에서 흡입할 때 단위 크기를 10byte로 하는 것이다. 
		...
		while((inputLength = System.in.read(dataArr)) != -1  ) {
			// -1은 키보드로 ctrl + c(강제종료)를 입력한 값이다. 
			// 키보드로 ctrl + c(강제종료)를 하면 while을 빠져나간다. 
			// System.in.read() 는 1byte씩 읽어온다.
        ...
        */
		...
		System.out.println("총 : " + (totalByte-2) + "byte 입력함"); // 엔터크기를 빼려고 -2를 해주었다. 	
