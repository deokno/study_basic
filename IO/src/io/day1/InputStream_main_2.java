...
*/   	
	...
	public static void main(String[] args) throws IOException {
		...
		while(true) {
			...
			System.out.write( input ); // System.out.write( input );을 사용하면 입력받은 글자를 int로 바꾸어서 출력되는 것이 아니라 글자 그대로 출력된다. 
			System.out.println();
			...
			if( input != 13 && input != 10) {
				...
				// System.out.write( input );을 사용하면 입력받은 글자를 int로 바꾸어서 출력되는 것이 아니라 글자 그대로 출력된다. 
				System.out.println();
			}
		}// end of while
