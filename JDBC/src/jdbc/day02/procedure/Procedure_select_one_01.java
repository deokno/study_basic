...
public class Procedure_select_one_01 {
	...
	public static void main(String[] args) {
         ...
         */
			...
			if( cstmt.getString(2) == null ) { // OUT모드 두번째 ? 네임. 
				System.out.println(">> 입력하신 학번" + stno + "은 존재하지 않습니다. <<");
			}
			else {
				System.out.println("----------------------------------------------------");
				System.out.println("▶ 학생명 : "+ cstmt.getString(2)); // 숫자 2는 프로시저 파라미터 중 두번째 파라미터의 ?(OUT MODE)를 말한다. 
				System.out.println("▶ 연락처 : "+ cstmt.getString(3)); // 숫자 3는 프로시저 파라미터 중 세번째 파라미터의 ?(OUT MODE)를 말한다. 
				System.out.println("▶ 주 소 : "+ cstmt.getString(4)); // 숫자 4는 프로시저 파라미터 중 네번째 파라미터의 ?(OUT MODE)를 말한다. 
				System.out.println("▶ 입학일자 : "+ cstmt.getString(5)); // 숫자 5는 프로시저 파라미터 중 다섯번째 파라미터의 ?(OUT MODE)를 말한다. 
				System.out.println("▶ 학급명 : "+ cstmt.getString(6)); // 숫자 6는 프로시저 파라미터 중 여섯번째 파라미터의 ?(OUT MODE)를 말한다. 
				System.out.println("▶ 교사명 : "+ cstmt.getString(7)); // 숫자 7는 프로시저 파라미터 중 일곱번째 파라미터의 ?(OUT MODE)를 말한다. 
				System.out.println("----------------------------------------------------");
			}
