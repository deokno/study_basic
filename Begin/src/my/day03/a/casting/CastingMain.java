...
public class CastingMain {
	...
	public static void main(String[] args) {
		...
		long ln = in; // int => 4byte  -2,147,483,648 ~ 2,147,483,647
		...
		System.out.println("ft=> " + ft); // float 단정밀도 소수점이하 7자리까지
		
		double db = ft; //double 배정밀도 소수점이하 15~16자리 까지 표현됨.
		// 위의 것은 double db =(double)ft;
		
		System.out.println("db =>" + db);
		// ft => 1.2339999675750732		
