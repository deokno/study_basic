...
public class Enum_main_2 {
	...
	public static void main(String[] args) {
		...
		// 모든 enum(열거형)은 추상 클래스 Enum의 자손이다.
		// 즉, enum(열거형)의 조상은 java.lang.Enum 클래스이다. 
		// 그러므로 enum(열거형)타입은 클래스이며 java.lang.Enum 클래스에서 정의되어진 메소드들을 사용할 수 있게 되어있다.
		
		/// *** enum(열거형)타입인 SeasonType_1에 열거되어진 데이터 값이 뭐가있는지 확인하고자 한다. ***
		...
		try {
			...
			// valueOf() 메소드는 열거형 SeasonType_1에서 문자열 "여름"과 일치하는 열거형 상수를 반환해주는 것이다. 
			...
			System.out.println(">> 열거형 상수는 "+str+"이 없습니다.<<");
		}
