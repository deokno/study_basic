	...
	public static void main(String[] args) {
		...
		System.out.println("\n ===== HashSet ===== \n");
	      ...
	      /*
	       	...
	       	이미 mbr_suji이 저장되었으므로 mbr_chaew 는 저장되지 않는다. 
	       */
	      ...
	      System.out.println(" 이순신을 삭제 한 후 ");
		...
		it = mbrHashSet.iterator();
		  ...
		  ////////////////////////////////////////////////////////////////////////////////////////////////
		      ...
		      /*
		       	mbr_suji_2 와 mbr_chaew 는 동일한 객체(차은우)를 가리키는 것이므로 
		       	이미 mbr_suji_2이 저장되었으므로 mbr_chaew_2 는 저장되지 않는다. 
		       */
