	...
	public static void main(String[] args) {
		...
		FunctionalInterArea_1 annony_area = new FunctionalInterArea_1() {
			...
			public void area(double x, double y, int type) {
				...
				case 3 :
					System.out.println("장축의 반지름 "+x+", 단축의 지름 "+y+" 인 타원형 면적은 : "+(3.14159F*x*y));
					break;
		...
		// 밑변 10.5, 높이 5.5 인 삼각형 면적은 : 28.875
		annony_area.area(10.5, 5.5, 3);
		// 장축의 반지름 10.5, 단축의 지름 5.5 인 타원형 면적은 : 181.42682933807373
...
/*
  ...
  */
		...
		FunctionalInterArea_1 lambda_area = (x, y, type) -> {
			...
			FunctionalInterOperator_3 annony_operator = new FunctionalInterOperator_3() {
				...
				@Override
				public double opreator(double a, double b, String type) {
					double result = 0.0;
			...
			double result = annony_operator.opreator(20, 10, "+");
			System.out.println(result);
		
			result = annony_operator.opreator(20, 10, "-");
			System.out.println(result);
			...
			result = lambda_operator_1.opreator(20, 10, "+");
			System.out.println(result);
	...
	// 2. 파라미터의 타입은 생략할 수 있다.
			...
			FunctionalInterOperator_3 lambda_operator_2 = (a, b, type) -> {
			...
			result = lambda_operator_2.opreator(20, 10, "+");
			System.out.println(result);
	...
	// 3. 실행명령문이 1개 이라면 { };을 생략할 수 있다.
		...
		FunctionalInterSearch_4 lambda_search_1 = (str) -> 
		System.out.println("회원들 중 \""+str+"\"를 조회합니다.");
	...
	// 4. 파라미터의 개수가 1개 이라면 파라미터를 감싸는 소괄호( )를 생략할 수 있다. 
		...
		FunctionalInterSearch_4 lambda_search_2 = str -> 
		System.out.println("회원들 중 \""+str+"\"를 조회합니다.");
...
/*		
		FunctionalInterOperator_3 lambda_operator_3 = a, b, type -> {
														오류 !!
			double result_3 = 0.0;
...
//		FunctionalInterPlus_6 lambda_plus_1 = (a, b) ->  
//			return a+b;
		FunctionalInterPlus_6 lambda_plus_1 = (a, b) -> { 
			return a+b; };
