...
public class WrapperMain {
	...
	public static void main(String[] args) {
		...
		System.out.println("=== auto Boxing 과 auto UnBoxing에 대해서 알아봅니다. ===");
	...
	int a3 = 20;
	Integer a4 = a3;	// auto Boxing
	System.out.println("a4 => " + a4); // auto UnBoxing
	...
	System.out.println("db2 => " + db2.doubleValue());
	// db2.doubleValue() 이 UnBoxing(언박싱) 이다.
	
	double db3 = 1.234567;
	Double db4 = db3;	// auto Boxing
	System.out.println("db4 => " + db4); // auto UnBoxing
	...
	char ch2 = (char)(chr + 32);  // auto UnBoxing
...
//	int ch_1_int = (int)ch_1; // 자동형변환이 되어져 생략된다.
