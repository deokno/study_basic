 ...
 */
	...
	public static void main(String[] args) {
		 ...
		 */
		outer:	// outer: 을 레이블이라고 부르는데 그 레이블명이 지금은 outer이다.
		for(;;) {
			try {
				System.out.print("\\n>> 몇단볼래? => \\n");
				...
				if( 2<= dan && dan <=9) {
					...
					if("N".equalsIgnoreCase(yn)){
						sc.close();
						break outer; // 레이블명이 outer라고 선언되어진 반복문을 빠져나오는 것이다.
				
					}
					
					else if("Y".equalsIgnoreCase(yn)){
						
						break; // break; 가장 가까운 반복문을 빠져나오는 것이다.
					}
...
}// end of public class Gugudan_main1
