...
public class Main_3 {
	...
	public static void main(String[] ags) {
		...
		emp.register(new Employee("wondewoman","0070","원더우먼","과장"));
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	System.out.println("\n ~~~ 와일드 카드의 하한 제한하기. T와 그 조상클래스들만 사용 가능한 경우 ~~~\n");
...
/*
 	register_executive(Box_Anything<? super Employee_Child_Executive> item) 이므로 
 	파라미터가 Employee_Child_Executive 을 포함한 Employee_Child_Executive의 조상클래스들만 
 	입력이 되어지므로 Employee_Child_Plain 을 형태를 띄는 box_plain은 입력이 불가하기 때문이다. 
 */
...
/////////////////////////////////////////////////////////////////////////////////////
	...
	System.out.println("\n ~~~ 와일드 카드의 상한 제한하기. T와 그 자손클래스들만 사용 가능한 경우 ~~~\n");
	
	
	Employee_Child_Plain_child plain_child_emp = new Employee_Child_Plain_child("kangkc","1237","강감찬","사원",3000,24);
...
/*
 	register_executive(Box_Anything<? super Employee_Child_Executive> item) 이므로 
 	파라미터가 Employee_Child_Plain를 포함한 자식클래스 까지만 입력이 가능한데
 	box_emp는 Box_Anything<Employee> 인데 이것은 Employee_Child_Plain 의 부모클래스 이므로
 	상한제한에 걸려서 입력이 불가하다. 
 */
