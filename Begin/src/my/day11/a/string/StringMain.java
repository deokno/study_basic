...
public class StringMain {
	...
	public static void main(String[] args) {
	   ...
	   */
	   ...
	   // 	strReverse.substring(0,"/가 최초로 나오는 위치");
	   ...
	   // "한석규-두석규-세석규-네SK-오SK"
	     ...
	     for(String s : strArr) {
	    	 ...
	    	 if(s != null && s.toLowerCase().indexOf(search)!= -1 ) {
	    		 // s.toLowerCase()은 전부 다 소문자로 바뀐다. "korea"," korea seoul", "korea 대한민국", "서울 korea 만세"
	    	 System.out.println(s);
	    	 } 
	     }// end of for
/*
	     for(int i=0; i<strArr.length; i++) {
	    	 if ("korea".equalsIgnoreCase(strArr[i]) ) {
	    		 System.out.println(strArr[i]);
	    	 }
	     }
*/ //내가 한 오답 	      
