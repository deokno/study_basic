...
//1.	int[] subjectArr; subjectArr = new int[7];
//2.	int[] subjectArr2 = new int[7];
...
//1.	int[] subjectArr; subjectArr = new int[7];
//2.	int[] subjectArr2 = new int[7];
//3.	int[] subjectArr3 = new int[] {100,90,95,70,98,100,90};
...
*/
	...
	//	>>> 확장된 for문(== 개선된 for문 == for each문) <<< //
		...
		for(int subj : subjectArr4 ) { // 100,90,95,70,98,100,90
			...
			// 반복하면서 배열방에 들어있던 값을 차례대로 int subj 변수 속에 넣어준다.
			...
			System.out.println("총점(100,90,95,70,98,100,90) : "+ am.habgae(100,90,95,70,98,100,90));
		
			System.out.println("총점(100,90,95,70,98,100,90) : "+ am.habgae(90,95,70,98,90));

	
	}//end of main(String[] args)

}//end of public class ArrayMain_1
